...
export default function Titlebar({ title }) {
  ...
  return (
    <div
      className={`flex justify-between items-center w-screen h-6 bg-black titlebar-drag ${
        maximized && 'titlebar-nodrag'
      }`}
    >
      <div className="flex justify-center items-center text-white px-2 py-1 titlebar-nodrag">
        {title}
      </div>
      <div className="flex justify-center items-center text-white h-full titlebar-nodrag">
        <div
          className="flex justify-center items-center w-6 h-6 hover:bg-gray-700 transition-colors duration-200 cursor-pointer"
        ...
        <div
          className="flex justify-center items-center w-6 h-6 hover:bg-red-700 transition-colors duration-200 cursor-pointer"
          onClick={handleClose}
        >
          <svg
            viewBox="0 0 11 11"
